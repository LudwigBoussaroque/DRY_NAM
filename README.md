...
# DRY_NAM
Characterizing drought onset, offset, duration, and intensity is important for understanding how drought events impact environmental or agricultural systems. In regions where precipitation may be bimodal, the complex hydroclimatic regime challenges standard approaches to drought event characterization, despite its critical importance for agro-environmental impact assessment and climate change studies. The R code presented here provides a comprehensive characterization of annual drought facets for unimodal and bimodal drought patterns, based on a daily drought index. It permits the extraction of 44 annual drought feature, such as onset, offset, duration, peak, drying and wetting rates, and severity, for both the pre- and post-monsoon drought periods.
